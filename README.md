...
I transform complex requirements into elegant code and enjoy collaborating on challenging projects that make a real impact.
...
<div>
  ...
  <img src="https://img.shields.io/badge/CSS3-%23663399?style=for-the-badge&logo=css3&logoColor=white">
</div>
...
### 🎮 **Uno Game - Networked Multiplayer Application**
A multiplayer implementation of Uno using advanced networking concepts
- **Technologies:** Java, Sockets, Broker Pattern
- **Key Features:** Real-time multiplayer, event-driven architecture
- **Focus:** Distributed systems, architectural patterns

### 🛒 **E-Commerce Platforms**
Full-featured e-commerce solutions with modern backend architecture
- **Technologies:** Jakarta EE, Spring Boot, MVC Architecture
- **Key Features:** Product management, order processing, user authentication
- **Focus:** Enterprise-level architecture, scalability

### 🔗 **ItsonConnect**
Secure connection management and authentication system
- **Technologies:** Spring Boot, JPA, Custom Security Algorithms
- **Key Features:** User authentication, secure session management, encryption
